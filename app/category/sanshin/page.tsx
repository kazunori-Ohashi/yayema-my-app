  ...
  const spots = [
    {
      id: "kabira-bay",
      title: "川平湾",
      image: "/images/kabira-bay.jpg",
      description: "透明度の高い美しい海が広がる、石垣島を代表する景勝地。グラスボートからは多彩な珊瑚礁や熱帯魚が見られます。",
      category: "自然",
    },
    {
      id: "yonehara-beach",
      title: "米原ビーチ",
      image: "/images/yonehara-beach.jpg",
      description: "シュノーケリングに最適な美しいビーチ。浅瀬でも色とりどりの魚や珊瑚礁を観察できます。",
      category: "ビーチ",
    },
    {
      id: "ishigaki-beef",
      title: "石垣牛グルメ",
      image: "/images/ishigaki-beef.jpg",
      description: "石垣島が誇るブランド牛「石垣牛」。島内の様々なレストランで味わえます。",
      category: "グルメ",
    },
  ]
